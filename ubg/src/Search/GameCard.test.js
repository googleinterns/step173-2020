...
const item = {'id': 296912, 'Name': 'Fort', 'minPlayer': 2, 'maxPlayer': 4,
...
it('renders without crashing', () => {
  ...
  ReactDOM.render(<GameCard id={item['id']} image={item['image']} name={item['Name']}
  year={item['year']} minTime={item['minPlaytime']} maxTime={item['maxPlaytime']}
  minPlayer={item['minPlayer']} maxPlayer={item['maxPlayer']} rating={item['rating']}
